...
intensity= Button(button_frame_middle, text="Intensity",command=lambda: intensityFunc(root, songList, nfft=1024, noverlap=512, freq_limit=20000) ,bg="brown1", fg="black", width = 15)
